...
std::vector<std::string> Renderer::sDebugMessages{};
bool                     Renderer::sErrorFlag = false;
...
void Renderer::debugOutput(unsigned int source, unsigned int type, unsigned int id, unsigned int severity,
